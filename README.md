...
# IMDB
  ...
  This super cool project was built using LaraKicks.
...
8. Run application (or if you have vhost or vps, then just skip remaining steps and go directly to http://127.0.0.1:8000)
